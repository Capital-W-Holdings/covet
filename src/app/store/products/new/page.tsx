...
export default function NewProductPage() {
  ...
  if (!user || (user.role !== 'STORE_ADMIN' && user.role !== 'COVET_ADMIN' && user.role !== 'SUPER_ADMIN')) {
    router.push('/login?redirect=/store/products/new');
    return null;
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Container className="py-8 max-w-3xl">
        <Link href="/store/products" className="text-sm text-gray-500 hover:text-gray-700 mb-4 block">
          ← Back to Products
        </Link>
        ...
        <form onSubmit={(e) => handleSubmit(e, false)}>
          {/* Images - Moved to top for better UX */}
          ...
          <Card className="p-6 mb-6">
            ...
            <div className="space-y-4">
              <Input
                ...
                required
                placeholder="e.g., Hermès Birkin 25 Togo Noir"
              />
